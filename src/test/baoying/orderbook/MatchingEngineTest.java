...
public class MatchingEngineTest {
	...
	public void testCreateBidBook(){
		...
		OriginalOrder o_100_1mio = new OriginalOrder(symbol, side, 100.1, 1000_000,  "orderID", "clientOrdID", "clientEntityID");
		OriginalOrder o_120_1mio = new OriginalOrder(symbol, side, 120.1, 1000_000,  "orderID", "clientOrdID", "clientEntityID");
		OriginalOrder o_130_1mio_sysT1 = new OriginalOrder(symbol, side, 130.1, 1000_000, "orderID", "clientOrdID", "clientEntityID");
		OriginalOrder o_130_1mio_sysT2 = new OriginalOrder(symbol, side, 130.1, 1000_000, "orderID", "clientOrdID", "clientEntityID");
...
//		}
	...
	public void testCreateAskBook(){
		...
		OriginalOrder o_140_1mio = new OriginalOrder(symbol, side, 140.1, 1000_000, "orderID", "clientOrdID", "clientEntityID");
		OriginalOrder o_150_1mio = new OriginalOrder(symbol, side, 150.1, 1000_000, "orderID", "clientOrdID", "clientEntityID");
		OriginalOrder o_160_1mio_sysT1 = new OriginalOrder(symbol, side, 160.1, 1000_000, "orderID", "clientOrdID", "clientEntityID");
		OriginalOrder o_160_1mio_sysT2 = new OriginalOrder(symbol, side, 160.1, 1000_000,  "orderID", "clientOrdID", "clientEntityID");
...
//		}
	...
	public void testMatch(){
		...
		{
			CommonMessage.Side side = CommonMessage.Side.OFFER;
			OriginalOrder o_140_1mio = new OriginalOrder(symbol, side, 140.1, 1000_000,  "orderID", "clientOrdID", "clientEntityID2");
			OriginalOrder o_150_1mio = new OriginalOrder(symbol, side, 150.1, 1000_000,  "orderID", "clientOrdID", "clientEntityID2");
			OriginalOrder o_160_1mio_sysT1 = new OriginalOrder(symbol, side, 160.1, 1000_000, "orderID", "clientOrdID", "clientEntityID2");
			OriginalOrder o_160_1mio_sysT2 = new OriginalOrder(symbol, side, 160.1, 1000_000, "orderID", "clientOrdID", "clientEntityID2");
		...
		OriginalOrder bid_145_1point5Mio = new OriginalOrder(symbol, CommonMessage.Side.BID, 155, 1500_000,  "orderID", "clientOrdID", "clientEntityID");
	...
	public void testBuildOrderbookSnapshot(){
		...
		PriorityQueue<ExecutingOrder> askBook = _exchange.createAskBook();
		{
			...
			OriginalOrder o_160_1mio_sysT1 = new OriginalOrder(symbol, side, 160.1, 1000_000,  "orderID", "clientOrdID", "clientEntityID");
			OriginalOrder o_160_1mio_sysT2 = new OriginalOrder(symbol, side, 160.1, 1000_000,  "orderID", "clientOrdID", "clientEntityID");
			OriginalOrder o_170_1mio = new OriginalOrder(symbol, side, 170.1, 1000_000,  "orderID", "clientOrdID", "clientEntityID");
